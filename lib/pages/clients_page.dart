  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<Clients>(
        builder: (context, Clients clientsList, Widget? child) {
            ...
            itemBuilder: (context, index) {
              return Dismissible(
                ...
                child: ListTile(
                  ...
                  title: Text(clientsList.clients[index].name +
                      ' (' +
                      clientsList.clients[index].type.name +
                      ')'),
                  iconColor: Colors.indigo,
                ),
                onDismissed: (direction) {
                  setState(() {
                    clientsList.clients.removeAt(index);
                  });
                },
              );
            },
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            actions: [
              ...
              Consumer<Clients>(
                builder: (context, clientsList, Widget? child) {
                  return TextButton(
